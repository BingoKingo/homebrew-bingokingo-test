...
**Cask** `font-tamal` was removed.

**Cask** `font-aptos-mono` was removed.

**Cask** `font-aptos-serif` was removed.

**Cask** `font-aptos` was removed.

**Cask** `font-arial-nova` was removed.

**Cask** `font-arial` was removed.

**Cask** `font-calibri` was removed.

**Cask** `font-candara` was removed.

**Cask** `font-consolas` was removed.

**Cask** `font-constantia` was removed.

**Cask** `font-corbel` was removed.

**Cask** `font-georgia-pro` was removed.

**Cask** `font-gill-sans-nova` was removed.

**Cask** `font-itc-avant-garde-gothic` was removed.

**Cask** `font-rockwell-nova` was removed.

**Cask** `font-rockwell` was removed.

**Cask** `font-segoe-marker` was removed.

**Cask** `font-sitka` was removed.

**Cask** `font-verdana-pro` was removed.
